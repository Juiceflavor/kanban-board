...
class BoardImplementsActiveTest {
    ...
    @Test
    void shouldActiveBoardIfExists() {
        // Arrange
        ...
        Mockito.when(boardJpaRepositoryAdapterMock.save(Mockito.any())).thenReturn(toEntity(boardModelMock.active()));

        // Act
        BoardModel response = boardImplements.active(boardModelMock.getId());
